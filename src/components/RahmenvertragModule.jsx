...
export default function RahmenvertragModule({ currentUser }) {
  ...
  return (
    <div className="flex h-full bg-gray-50">
      {/* LEFT — hidden on mobile when editing */}
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="bg-white border-b border-gray-200 px-3 md:px-4 py-2 flex flex-wrap items-center gap-2 flex-shrink-0">
            <div className="flex items-center gap-2 mr-auto min-w-0">
              ...
              <span className="font-semibold text-gray-800 text-sm truncate">{selected.recipientCompany || selected.recipientName || 'Neuer Rahmenvertrag'}</span>
