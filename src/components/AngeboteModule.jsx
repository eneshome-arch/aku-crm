...
const EINRICHTUNG_TYPEN = {
  pflegeheim: {
    ...
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die Überlassung von qualifiziertem Pflegepersonal an Einrichtungen der stationären und ambulanten Pflege. Unsere Mitarbeiterinnen und Mitarbeiter werden sorgfältig ausgewählt, sind examiniert oder entsprechend qualifiziert und stehen Ihnen bundesweit kurzfristig zur Verfügung. Für eine reibungslose Einsatzplanung und Koordination nutzen wir InSitu – unser digitales Tool für transparente Kommunikation, Einsatzdokumentation und schnelle Abstimmung zwischen Ihnen und unserem Team.',
  ...
  eingliederung: {
    ...
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die Überlassung von pädagogischem und pflegerischem Fachpersonal für Einrichtungen der Eingliederungshilfe. Unsere Mitarbeiterinnen und Mitarbeiter verfügen über Erfahrung in der Arbeit mit Menschen mit Behinderung und stehen Ihnen bundesweit kurzfristig zur Verfügung. Über unser digitales Tool InSitu koordinieren wir Einsätze transparent und ermöglichen eine direkte Kommunikation zwischen Ihrer Einrichtung und unserem Team.',
  ...
  logistik: {
    label: '🚛 Logistik / Lager / Versand',
    subjectTitle: 'Zuverlässiges Lagerpersonal\nfür Ihr Unternehmen',
    introText: 'vielen Dank für die Möglichkeit, Ihnen unser Leistungsangebot vorzustellen. Gerne möchten wir Ihnen unsere Unterstützung im Bereich Arbeitnehmerüberlassung für Lager, Logistik und Kommissionierung anbieten. Wir unterstützen Unternehmen dabei, kurzfristige Personalengpässe flexibel zu überbrücken und ihren Personalbedarf zuverlässig abzudecken.',
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die flexible Überlassung von Fach- und Hilfskräften für Logistik, Lager und Versand. Unsere Mitarbeiterinnen und Mitarbeiter sind erfahren im Umgang mit Warenwirtschaftssystemen, Kommissionierung und Versandabwicklung – und stehen Ihnen bundesweit auch kurzfristig zur Verfügung. Die gesamte Einsatzkoordination erfolgt über InSitu, unser digitales Tool für transparente Schichtplanung, Echtzeit-Kommunikation und lückenlose Einsatzdokumentation.',
  ...
  produktion: {
    ...
    subjectTitle: 'Zuverlässiges Produktionspersonal\nfür Ihr Unternehmen',
    introText: 'vielen Dank für die Möglichkeit, Ihnen unser Leistungsangebot vorzustellen. Gerne möchten wir Ihnen unsere Unterstützung im Bereich Arbeitnehmerüberlassung für Produktion und Fertigung anbieten. Wir unterstützen Industrieunternehmen dabei, Produktionsspitzen flexibel abzudecken und ihren Personalbedarf zuverlässig zu sichern.',
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die flexible Überlassung von Produktionsmitarbeitern, Maschinenbedienern und Fertigungshelfern an Industrieunternehmen. Unsere Mitarbeiterinnen und Mitarbeiter sind erfahren im Umgang mit Produktionsabläufen, Qualitätsstandards und Sicherheitsvorschriften – und stehen Ihnen bundesweit auch kurzfristig zur Verfügung. Über InSitu, unser digitales Koordinationstool, steuern wir Schichtplanung, Einsatzdokumentation und Kommunikation effizient und in Echtzeit.',
    highlightText: 'Produktionskapazitäten flexibel hochfahren – ob Serienfertigung, Sonderaufträge oder saisonale Spitzen. Einsatzbereites Personal mit Produktionserfahrung, genau dann wenn Sie es brauchen.',
    pricing: [
      { qualifikation: 'Produktionshelfer/in', badge: 'Hilfskraft', badgeColor: 'gray', einsatz: 'Montage, Verpackung, Zuarbeit', preis: '25,50' },
      { qualifikation: 'Produktionsmitarbeiter/in', badge: 'Erfahren', badgeColor: 'blue', einsatz: 'Fertigung, Qualitätskontrolle', preis: '27,50' },
      { qualifikation: 'Maschinenführer/in', badge: 'Fachkraft', badgeColor: 'green', einsatz: 'CNC, Maschinenbedienung, Einrichtung', preis: '32,00' },
    ],
  },
  automotive: {
    label: '🚗 Automotive / Zulieferer',
    subjectTitle: 'Qualifiziertes Produktionspersonal\nfür Ihr Automobilunternehmen',
    introText: 'vielen Dank für die Möglichkeit, Ihnen unser Leistungsangebot vorzustellen. Gerne möchten wir Ihnen unsere Unterstützung im Bereich Arbeitnehmerüberlassung für die Automobilindustrie und Zuliefererbranche anbieten. Wir unterstützen Unternehmen dabei, Produktionskapazitäten flexibel zu skalieren und Personalengpässe zuverlässig zu überbrücken.',
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die flexible Überlassung von Fach- und Produktionskräften an Automobilhersteller und Zulieferer. Unsere Mitarbeiterinnen und Mitarbeiter kennen die hohen Qualitätsanforderungen der Branche, sind vertraut mit Schichtmodellen und Fertigungsprozessen – und stehen Ihnen bundesweit kurzfristig zur Verfügung. Die Einsatzsteuerung erfolgt über InSitu, unser digitales Tool für transparente Schichtkoordination, Echtzeit-Kommunikation und lückenlose Dokumentation.',
    highlightText: 'Fertigungslinien lückenlos besetzen – ob Modellanlauf, Serienfertigung oder kurzfristiger Mehrbedarf. Sie erhalten sofort einsatzbereites Personal mit Automotive-Erfahrung, an jedem Standort in Deutschland.',
    pricing: [
      { qualifikation: 'Produktionshelfer/in', badge: 'Angelernt', badgeColor: 'gray', einsatz: 'Montage, Bestückung, Verpackung', preis: '26,00' },
      { qualifikation: 'Produktionsmitarbeiter/in', badge: 'Erfahren', badgeColor: 'blue', einsatz: 'Bandarbeit, Qualitätsprüfung', preis: '28,50' },
      { qualifikation: 'Facharbeiter/in Metall', badge: 'Ausbildung', badgeColor: 'green', einsatz: 'CNC, Schweißen, Schlosserei', preis: '34,00' },
    ],
  },
  industrie: {
    label: '⚙️ Industrie / Metallverarbeitung',
    subjectTitle: 'Fachpersonal für Produktion & Fertigung\nfür Ihr Industrieunternehmen',
    introText: 'vielen Dank für die Möglichkeit, Ihnen unser Leistungsangebot vorzustellen. Gerne möchten wir Ihnen unsere Unterstützung im Bereich Arbeitnehmerüberlassung für die industrielle Fertigung und Metallverarbeitung anbieten. Wir unterstützen Unternehmen dabei, qualifiziertes Fachpersonal flexibel und kurzfristig einzusetzen.',
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die Überlassung von Fachkräften und Helfern für Industrieunternehmen. Unsere Mitarbeiterinnen und Mitarbeiter verfügen über Erfahrung in der Metallverarbeitung, Maschinenbedienung und industriellen Fertigung – und stehen Ihnen bundesweit auch kurzfristig zur Verfügung. Über InSitu koordinieren wir Einsätze digital: transparente Schichtplanung, Dokumentation und direkte Kommunikation in Echtzeit.',
    highlightText: 'Auftragsspitzen und Personalengpässe flexibel abfangen – mit qualifiziertem Industriepersonal, das Ihre Fertigungsprozesse kennt und sofort einsatzbereit ist.',
    pricing: [
      { qualifikation: 'Fertigungshelfer/in', badge: 'Hilfskraft', badgeColor: 'gray', einsatz: 'Zuarbeit, Entgraten, Verpackung', preis: '25,50' },
      { qualifikation: 'Industriemechaniker/in', badge: 'Ausbildung', badgeColor: 'blue', einsatz: 'Montage, Instandhaltung', preis: '32,00' },
      { qualifikation: 'CNC-Fachkraft', badge: 'Fachqualifikation', badgeColor: 'green', einsatz: 'CNC-Drehen, CNC-Fräsen', preis: '35,00' },
    ],
  },
  lebensmittel: {
    label: '🍔 Lebensmittelproduktion',
    subjectTitle: 'Zuverlässiges Produktionspersonal\nfür Ihre Lebensmittelfertigung',
    introText: 'vielen Dank für die Möglichkeit, Ihnen unser Leistungsangebot vorzustellen. Gerne möchten wir Ihnen unsere Unterstützung im Bereich Arbeitnehmerüberlassung für die Lebensmittelproduktion und -verarbeitung anbieten. Wir unterstützen Unternehmen dabei, saisonale Spitzen und Personalengpässe flexibel zu überbrücken.',
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die Überlassung von Produktions- und Verpackungspersonal für die Lebensmittelindustrie. Unsere Mitarbeiterinnen und Mitarbeiter sind vertraut mit Hygienevorschriften (HACCP), Schichtarbeit und den besonderen Anforderungen der Lebensmittelbranche – und stehen Ihnen bundesweit kurzfristig zur Verfügung. Über unser digitales Tool InSitu gewährleisten wir transparente Einsatzplanung, Schichtkoordination und lückenlose Dokumentation.',
    highlightText: 'Produktionslinien auch in Hochphasen voll besetzt halten – mit hygienisch geschultem Personal, das Ihre Abläufe und Standards kennt. Bundesweit verfügbar.',
    pricing: [
      { qualifikation: 'Produktionshelfer/in', badge: 'Hilfskraft', badgeColor: 'gray', einsatz: 'Verpackung, Sortierung, Zuarbeit', preis: '25,00' },
      { qualifikation: 'Produktionsmitarbeiter/in', badge: 'Erfahren', badgeColor: 'blue', einsatz: 'Maschinenbedienung, Qualitätskontrolle', preis: '27,00' },
      { qualifikation: 'Fachkraft Lebensmitteltechnik', badge: 'Ausbildung', badgeColor: 'green', einsatz: 'Anlagenführung, HACCP', preis: '31,00' },
    ],
  },
  elektro: {
    label: '⚡ Elektro / Elektrotechnik',
    subjectTitle: 'Qualifiziertes Fachpersonal\nfür Ihr Elektrounternehmen',
    introText: 'vielen Dank für die Möglichkeit, Ihnen unser Leistungsangebot vorzustellen. Gerne möchten wir Ihnen unsere Unterstützung im Bereich Arbeitnehmerüberlassung für die Elektrotechnik und Elektroindustrie anbieten. Wir unterstützen Unternehmen dabei, qualifizierte Elektrofachkräfte und Helfer flexibel einzusetzen.',
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die Überlassung von Elektrofachkräften und technischem Personal. Unsere Mitarbeiterinnen und Mitarbeiter verfügen über entsprechende Qualifikationen, Sicherheitsunterweisungen und Berufserfahrung – und stehen Ihnen bundesweit auch kurzfristig zur Verfügung. Die Einsatzkoordination erfolgt über InSitu, unser digitales Tool für Projektplanung, Dokumentation und direkte Kommunikation in Echtzeit.',
    highlightText: 'Projekte und Aufträge termingerecht abschließen – mit qualifizierten Elektrofachkräften, die Ihre Sicherheitsstandards kennen und sofort produktiv sind.',
    pricing: [
      { qualifikation: 'Elektrohelfer/in', badge: 'Angelernt', badgeColor: 'gray', einsatz: 'Kabelzug, Zuarbeit, Montage', preis: '26,00' },
      { qualifikation: 'Elektroniker/in', badge: 'Ausbildung', badgeColor: 'blue', einsatz: 'Installation, Verdrahtung, Prüfung', preis: '33,00' },
      { qualifikation: 'Elektrofachkraft', badge: 'Meister / Techniker', badgeColor: 'green', einsatz: 'Schaltschrankbau, SPS, Inbetriebnahme', preis: '38,00' },
    ],
  },
  reinigung: {
    label: '🧹 Gebäudereinigung / Facility',
    subjectTitle: 'Zuverlässiges Reinigungspersonal\nfür Ihr Unternehmen',
    introText: 'vielen Dank für die Möglichkeit, Ihnen unser Leistungsangebot vorzustellen. Gerne möchten wir Ihnen unsere Unterstützung im Bereich Arbeitnehmerüberlassung für Gebäudereinigung und Facility-Services anbieten.',
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die flexible Überlassung von Reinigungskräften und Facility-Personal. Unsere Mitarbeiterinnen und Mitarbeiter sind zuverlässig, erfahren im Umgang mit professionellen Reinigungsmitteln und -geräten und stehen Ihnen bundesweit kurzfristig zur Verfügung. Über InSitu steuern wir Einsatzplanung und Objektkoordination digital – für transparente Abläufe und direkte Kommunikation.',
    highlightText: 'Sauberkeit und Hygiene zuverlässig gewährleisten – auch bei kurzfristigen Personalausfällen. Flexibel buchbar, bundesweit verfügbar.',
    pricing: [
      { qualifikation: 'Reinigungskraft', badge: 'Hilfskraft', badgeColor: 'gray', einsatz: 'Unterhaltsreinigung, Büroreinigung', preis: '23,00' },
      { qualifikation: 'Reinigungskraft', badge: 'Erfahren', badgeColor: 'blue', einsatz: 'Grundreinigung, Sonderreinigung', preis: '25,50' },
      { qualifikation: 'Gebäudereiniger/in', badge: 'Ausbildung', badgeColor: 'green', einsatz: 'Glas-, Fassadenreinigung, Objektleitung', preis: '29,00' },
    ],
  },
  hotel: {
    label: '🏨 Hotellerie / Gastronomie',
    subjectTitle: 'Flexibles Servicepersonal\nfür Ihr Hotel oder Restaurant',
    introText: 'vielen Dank für die Möglichkeit, Ihnen unser Leistungsangebot vorzustellen. Gerne möchten wir Ihnen unsere Unterstützung im Bereich Arbeitnehmerüberlassung für Hotellerie und Gastronomie anbieten. Wir unterstützen Betriebe dabei, saisonale Spitzen und Personalengpässe flexibel abzudecken.',
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die flexible Überlassung von Service-, Küchen- und Housekeeping-Personal für die Hotel- und Gastronomiebranche. Unsere Mitarbeiterinnen und Mitarbeiter bringen Branchenerfahrung, Serviceorientierung und Flexibilität mit – und stehen Ihnen bundesweit auch kurzfristig zur Verfügung. Über InSitu koordinieren wir Einsätze digital: Dienstplanung, Kommunikation und Dokumentation in Echtzeit.',
    highlightText: 'Gästeservice auch in Spitzenzeiten auf höchstem Niveau halten – mit erfahrenem Servicepersonal, das Ihre Abläufe kennt und sofort einsatzbereit ist.',
    pricing: [
      { qualifikation: 'Küchenhilfe', badge: 'Hilfskraft', badgeColor: 'gray', einsatz: 'Spüle, Vorbereitung, Zuarbeit', preis: '24,00' },
      { qualifikation: 'Servicekraft', badge: 'Erfahren', badgeColor: 'blue', einsatz: 'Frühstück, Bankett, Restaurant', preis: '26,50' },
      { qualifikation: 'Koch / Köchin', badge: 'Ausbildung', badgeColor: 'green', einsatz: 'À la carte, Bankettküche', preis: '32,00' },
    ],
  },
}
