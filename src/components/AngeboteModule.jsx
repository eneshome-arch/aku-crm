...
<head>
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .page { width:210mm; height:297mm; margin:0 auto; background:#fff; display:flex; flex-direction:column; position:relative; overflow:hidden; page-break-after:always; }
    .page-2 { width:210mm; height:297mm; margin:0 auto; background:#fff; display:flex; flex-direction:column; overflow:hidden; page-break-before:always; }
    ...
    @media print { body { -webkit-print-color-adjust:exact; print-color-adjust:exact; } .page, .page-2 { margin:0; width:100%; height:100%; } @page { margin:0; size:A4; } }
  </style>
</head>
<body>
<div class="page">
