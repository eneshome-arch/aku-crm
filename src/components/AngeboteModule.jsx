...
const EINRICHTUNG_TYPEN = {
  ...
  industrie: {
    ...
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die Überlassung von Fachkräften und Helfern für Industrieunternehmen. Unsere Mitarbeiterinnen und Mitarbeiter verfügen über Erfahrung in der Metallverarbeitung, Maschinenbedienung und industriellen Fertigung – und stehen Ihnen bundesweit auch kurzfristig zur Verfügung.',
  ...
  lebensmittel: {
    ...
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die Überlassung von Produktions- und Verpackungspersonal für die Lebensmittelindustrie. Unsere Mitarbeiterinnen und Mitarbeiter sind vertraut mit Hygienevorschriften (HACCP), Schichtarbeit und den besonderen Anforderungen der Lebensmittelbranche – und stehen Ihnen bundesweit kurzfristig zur Verfügung.',
  ...
  elektro: {
    ...
    body2: 'Zeitblick Personalservice ist ein deutschlandweit tätiger Personaldienstleister mit Sitz in Hannover, spezialisiert auf die Überlassung von Elektrofachkräften und technischem Personal. Unsere Mitarbeiterinnen und Mitarbeiter verfügen über entsprechende Qualifikationen, Sicherheitsunterweisungen und Berufserfahrung – und stehen Ihnen bundesweit auch kurzfristig zur Verfügung.',
